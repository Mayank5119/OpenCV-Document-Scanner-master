# USAGE:
# python scan.py (--images sample_images | --image cell_pic.jpg) [-i]
...
# Scanned images will be output to directory named 'outpython scan.py --images sample_imagesput'
...
if __name__ == "__main__":
    ...
    im_dir = "sample_images"
    im_file_path = "cell_pic.jpg"
    interactive_mode = True
    print('interactive_mode = '+str(interactive_mode))
    ...
    if im_file_path:
        ...
        scanner.scan('sample_images/cell_pic.jpg')
